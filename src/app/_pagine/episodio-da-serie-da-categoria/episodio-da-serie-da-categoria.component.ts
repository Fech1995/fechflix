...
@Component({
  selector: 'app-episodio-da-serie-da-categoria',
  templateUrl: './episodio-da-serie-da-categoria.component.html',
  styleUrls: ['./episodio-da-serie-da-categoria.component.scss']
})
export class EpisodioDaSerieDaCategoriaComponent {
