...
@Component({
  selector: 'tipologie-libri',
  templateUrl: './tipologie-libri.component.html',
  styleUrls: ['./tipologie-libri.component.scss']
})
export class TipologieLibriComponent implements OnInit {
      ...
      next: (rit: IRispostaServer) => {
        ...
        for (let i = 0; i < elementi.length; i++) {
          ...
          const bott: Bottone = {
            ...
            tipo: "button",
            emitId: null,
            link: "/tipologie/elenco/" + elementi[i].id
          }
          const card: Card = {
            immagine: tmpImg,
            testo: '',
